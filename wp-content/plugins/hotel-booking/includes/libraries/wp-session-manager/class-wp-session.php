 ...
 * @since   3.7.0
 */
final class MPHB_WP_Session extends MPHB_Recursive_ArrayAccess implements Iterator, Countable {
	/**
	...
	protected function __construct() {
		if ( isset( $_COOKIE[MPHB_WP_SESSION_COOKIE] ) ) {
			$cookie = stripslashes( $_COOKIE[MPHB_WP_SESSION_COOKIE] );
	...
	protected function set_cookie() {
		setcookie( MPHB_WP_SESSION_COOKIE, $this->session_id . '||' . $this->expires . '||' . $this->exp_variant , $this->expires, COOKIEPATH, COOKIE_DOMAIN );
	}
