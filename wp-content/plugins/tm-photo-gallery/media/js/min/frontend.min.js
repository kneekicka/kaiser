...
!function(e){"use strict";e(document).ready(function(){e(".tm-pg_frontend").each(function(){var t=e(this).attr("data-id");Registry._get("grid").init(t)});var t=e(".filter-select");e(document).on("click",".filter-select .filter-select__panel",function(){t.hasClass("open")?t.removeClass("open"):t.addClass("open")}),e(document).on("click",function(n){e(n.target).closest(t).length||e(n.target).closest(t).length||(t.hasClass("open")&&t.removeClass("open"),n.stopPropagation())})})}(jQuery);
Registry.register("grid",function(t){"use strict";function n(n){return t(i(n))}function i(t){return _.isUndefined(r.ID)?d+" "+t:d+'[data-id="'+r.ID+'"] '+t}function e(t){return Registry._get(t)}function a(n,e){t(document).off("click",i(n)).on("click",i(n),function(t){t.preventDefault(),!_.isUndefined(e)&&_.isFunction(e)&&e(this,t)})}function o(){return{ID:0,_item:".gallery-item",_load:{grid:".gallery-item_show-more",btn:".load-more-button"},_content:{grid:".tm-pg_front_gallery-grid .row",masonry:".tm-pg_front_gallery-masonry",justify:".tm-pg_front_gallery-justify"},_pagination:{content:".tm-pg_front_gallery-navigation",numbers:".navigation.pagination"},_filter:{line:{item:".tm-pg_front_gallery-tabs li a",content:".tm-pg_front_gallery-tabs"},dropdown:{item:".filter-select__list li a",content:".filter-select"}},_input:{term_id:'input[name="term_id"]',term_type:'input[name="term_type"]',offset:'input[name="offset"]',per_page:'input[name="images_per_page"]',count:'input[name="all_count"]'},getID:function(t){return t.parents(d).data("id")},gridInit:function(){e("slider").init(),a(r._load.grid+" a",function(n){r.ID=r.getID(t(n)),r.loadMore("append"),t(n).parent().remove()})},paginationInit:function(){a(r._pagination.content+" a",function(n){var i=t(n),e=i.parents(r._pagination.content);if(i.hasClass("current"))return!1;if(i.hasClass("next")){var a=e.find("a.current").text();r.clickPagination(++a,e,function(){e.find('a[data-pos="'+a+'"]').addClass("current")})}else if(i.hasClass("prev")){var a=e.find("a.current").text();r.clickPagination(--a,e,function(){e.find('a[data-pos="'+a+'"]').addClass("current")})}else r.clickPagination(i.text(),e,function(){i.addClass("current")})}),a(r._load.btn+" a",function(i){n(r._load.grid).remove(),r.ID=r.getID(t(i)),r.loadMore("append")})},clickPagination:function(t,i,e){i.find("a").removeClass("current");var a=n(r._input.offset),o=n(r._input.per_page);t--,a.val(o.val()*t),r.ID=r.getID(i),r.loadMore("replase",function(){t>0?i.find("a.prev").show():i.find("a.prev").hide(),t++,t<i.find(r._pagination.numbers).data("count")?i.find("a.next").show():i.find("a.next").hide(),!_.isUndefined(e)&&_.isFunction(e)&&e()})},init:function(n){r.ID=n,r.checkLoadMore(),r.gridInit(),r.paginationInit(),a(r._filter.dropdown.item,function(n){r.sortGrid(t(n))}),a(r._filter.line.item,function(n){r.sortGrid(t(n))})},updateURLParameter:function(t,n){if(history.pushState){var i=window.location.protocol+"//"+window.location.host+window.location.pathname+"?"+t+"="+n;window.history.pushState({path:i},"",i)}},loadMore:function(i,a){_.isUndefined(i)&&(i="append");var o=n(r._input.offset),p=n(r._input.per_page),c=n(r._input.term_id),l=n(r._input.term_type),s=t(d).data("view");_.isEqual(i,"append")&&!o.val()&&o.val(Number(o.val())+Number(p.val())),r.getContent(o.val(),p.val(),c.val(),l.val(),function(o){if(_.isEqual(i,"replase")&&n(r._content[s]).html(""),t.each(o,function(t,i){n(r._content[s]).append(i)}),r.checkLoadMore(),e("slider").remove(),r.gridInit(),t(r._pagination.content).length){var d=t("a.current",r._pagination.numbers).last().next();d.addClass("current"),t("a.next",r._pagination.numbers).hide(),t("a.prev",r._pagination.numbers).hide()}!_.isUndefined(a)&&_.isFunction(a)&&a()})},checkLoadMore:function(){var i=n(r._input.offset),e=n(r._input.per_page),a=n(r._input.term_id),o=Number(t(d+' a[data-id="'+a.val()+'"]').data("count"));o=_.isNaN(o)?n(r._input.count).val():o,i.val(Number(i.val())+Number(e.val())),i.val()>=o?(n(r._load.btn).hide(),n(r._load.grid).hide()):(n(r._load.btn).show(),n(r._load.grid).show())},sortGrid:function(i){r.ID=r.getID(i);var a=i.attr("data-id"),o=i.attr("data-type"),_=t(d).data("view");r.filterContent(a,o,function(d){n(r._filter.dropdown.content).removeClass("open"),n(r._filter.dropdown.content).find("li").removeClass("active"),n(r._filter.line.content).find("li").removeClass("active"),i.parents("li").addClass("active"),n(r._content[_]).html(""),t.each(d,function(t,i){n(r._content[_]).append(i)}),n(r._input.term_id).val(a),n(r._input.term_type).val(o),n(r._input.offset).val(0),n(r._pagination.content).data("load-more-page")?r.getPagination(a,o,function(t){n(r._pagination.content).html(t),r.checkLoadMore(),r.paginationInit(),e("slider").remove(),r.gridInit()}):(r.checkLoadMore(),e("slider").remove(),r.gridInit())})},filterContent:function(i,e,a){var o={action:"tm_pg_f",post_id:n("").data("post-id"),fields:"all"},d=n(r._input.per_page);o[window.tm_pg_options.action]="filter_grid",o.controller="grid",o.term_id=i,o.id=r.ID,o.type=e,o.images_per_page=d.val(),o.tm_pg_nonce=window.tm_pg_options.nonce,t.post(window.tm_pg_options.ajax_url,o,function(t){!_.isUndefined(a)&&_.isFunction(a)&&a(t.data)})},getContent:function(i,e,a,o,d){var p={action:"tm_pg_f",controller:"grid",shortcode:"grid",fields:"all",post_id:n("").data("post-id"),term_id:a,type:o,id:r.ID,offset:i,images_per_page:e};p.tm_pg_nonce=window.tm_pg_options.nonce,p[window.tm_pg_options.action]="get_content",t.post(window.tm_pg_options.ajax_url,p,function(t){t.success&&!_.isUndefined(d)&&_.isFunction(d)&&d(t.data)})},getPagination:function(n,i,e){var a={action:"tm_pg_f"};a[window.tm_pg_options.action]="get_pagination",a.controller="grid",a.id=r.ID,a.term_id=n,a.type=i,a.tm_pg_nonce=window.tm_pg_options.nonce,t.post(window.tm_pg_options.ajax_url,a,function(t){t.success&&!_.isUndefined(e)&&_.isFunction(e)&&e(t.data)})}}}var r,d=".tm-pg_frontend";return{getInstance:function(){return r||(r=o()),r}}}(jQuery));
Registry.register("slider",function(t){"use strict";function n(){return{gallery:{},_content:{grid:".tm-pg_front_gallery-grid .row",masonry:".tm-pg_front_gallery-masonry",justify:".tm-pg_front_gallery-justify"},_item:'div.gallery-item[data-type="img"] a',init:function(){setTimeout(function(){var n=t(r).data("view");t(e._content[n]).lightGallery({selector:e._item,thumbnail:!0,animateThumb:!0,showThumbByDefault:!0,toogleThumb:!0,thumbContHeight:80}),t(e._content[n]).on("onBeforeOpen.lg",function(n){t("#wpadminbar").css("z-index","0")}),t(e._content[n]).on("onCloseAfter.lg",function(n){t("#wpadminbar").css("z-index","")}),e.gallery=t(e._content[n]).data("lightGallery")},200)},remove:function(){e.gallery.destroy(!0)}}}var e,r=".tm-pg_frontend";return{getInstance:function(){return e||(e=n()),e}}}(jQuery));
