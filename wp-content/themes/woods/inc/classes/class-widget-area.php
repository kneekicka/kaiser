...
if ( ! class_exists( 'Woods_Widget_Area' ) ) {
	...
	class Woods_Widget_Area {
		...
		function __construct() {
			...
			add_action( 'woods_render_widget_area', array( $this, 'render' ) );
		}
		...
		public function render( $area_id ) {
			...
			$area_id        = apply_filters( 'woods_rendering_current_widget_area', $area_id );
			...
			$classes = apply_filters( 'woods_widget_area_classes', $classes, $area_id );
